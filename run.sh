...
case $command in
    provision)
        ...
        while test $# -gt 0; do
            case "$1" in
            latest | 2.12.0 | 2.14.0 | 2.16.0 | 2.18.0 | 2.20.0 | 2.20.1 | 3.0 )
            ...
            all)
                ...
                echo "2.16.0, 2.18.0, 2.20.0, 2.20.0, 3.0 and latest"
                echo
    ...
    run)
        ...
        echo "(e.g. latest, 2.12.0, 2.14.0, 2.16.0, 2.18.0, 2.20.0, 2.20.1, 3.0)"
        echo
    LOCALDIR="$(pwd)"
    while test $# -gt 1; do
        case "$1" in
